...
export const Login = () => {
    ...
    return (
        <ScrollView keyboardShouldPersistTaps={'handled'} contentContainerStyle={[{ minHeight: '100%' }, padding(0, 35, 20), styles.bgWhite, styles.spaceAround]}>
            <View>
                <BackButton />
            </View>
            <View style={[]}>
                <LogoComponent text={'Login to your Account'} />
            </View>
            <View>
                ...
                <Text style={[error !== '' ? margin(0, 0, 20) : margin(0), styles.Red, { textAlign: 'center' }]}>{error}</Text>
                ...
                <TouchableOpacity>
                    <Text style={[marginPosition(4, 0, 10, 0), styles.Red, { textAlign: 'center' }, fontWeight(500), fontSize(14)]}>Forgot the Password?</Text>
                </TouchableOpacity>
            </View>
            <View style={[styles.row, styles.allCenter, marginPosition(0, 0, 10, 0)]}>
                ...
                <Text style={[{ color: '#00000080', }, styles.Black, fontSize(16)]}>or Continue with</Text>
